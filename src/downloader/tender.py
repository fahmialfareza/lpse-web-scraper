...
def download_tender_data():
    ...
    # Define the URL
    url = f"{LPSE_URL}/eproc4/dt/lelang?draw=1&start=0&length={LPSE_LELANG_DATA_LENGTH}&authenticityToken={LPSE_AUTHENTICITY_TOKEN}"
    ...
    response = post(
        ...
        headers={
            ...
            "Referer": f"{LPSE_URL}/eproc4/lelang",
            "Origin": f"{LPSE_URL}",
