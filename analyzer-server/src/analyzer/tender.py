...
class TenderAnalyzer:
    ...
    def visualize_tender_data_image(
        self, visualize_tender_type="Jumlah Tender", top=10, filename=None
    ):
        """Visualize tender data and save as image in /tmp directory
        ...
        Args:
            visualize_tender_type (str): Type of visualization to be performed
                ...
                - "Total Harga Penawaran"
            top (int): Number of top results to be displayed
            filename (str, optional): Custom filename for the image. Defaults to None.
        Returns:
        ...
        if filename is None:
            filename = f"tender_{uuid.uuid4().hex}.png"
...
def run_tender_analyzer(
    ...
    return tender_analyzer.visualize_tender_data_image(
